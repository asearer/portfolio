...
const About = () => {
  ...
  return (
    <section className="about-section">
      ...
      <p><strong>Overview:</strong> Mastered responsive design techniques and best practices, including media queries, Flexbox, and Grid Layout. Proficient in creating flexible, mobile-first websites that adapt seamlessly to various screen sizes.</p><br />
      ...
      <p><strong>Overview:</strong> Acquired comprehensive software engineering skills, including project management, software development methodologies, and advanced programming techniques. Gained hands-on experience in designing, developing, and deploying scalable software solutions.</p><br />

      <p><strong>Data Visualization</strong></p>
      <p><strong>Date Acquired:</strong> July 2024</p>
      <p><strong>Institution:</strong> FreeCodeCamp</p>
      <p><strong>Overview:</strong> Specialized in transforming complex data into clear, insightful visualizations using tools like D3.js and Python libraries. Developed the ability to communicate data-driven insights effectively through charts, graphs, and interactive dashboards.</p><br />
